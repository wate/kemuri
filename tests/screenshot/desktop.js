...
const outputFileSuffix = process.env.SCREENSHOT_DESKTOP_OUTPUT_FILE_SUFFIX || '-desktop';
const screenSizeWight = process.env.SCREENSHOT_DESKTOP_SIZE_WIDTH || 1600;
const screenSizeHeight = process.env.SCREENSHOT_DESKTOP_SIZE_HEIGHT || 1000;
